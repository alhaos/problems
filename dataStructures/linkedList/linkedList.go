// Связный список структура данных позволяющая хранить список значений,
// в отличии от массива в памяти храниться не сплошным куском, а отдельными
// частями которые ссылаются на другие части.
